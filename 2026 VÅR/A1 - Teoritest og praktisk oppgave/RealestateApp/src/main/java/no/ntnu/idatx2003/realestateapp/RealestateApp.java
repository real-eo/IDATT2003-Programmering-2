...
public class RealestateApp {
  ...
  private static final int FIND_PROPERTY_BY_ID = 3;
  private static final int FIND_PROPERTIES_BY_OWNER = 4;
  private static final int CALCULATE_AVERAGE_AREA = 5;
  ...
  public void addRealestatToRegister() {
    ...
    // Municipality number
    System.out.println("Municipality number (0101 - 5444): ");
    ...
    if (userInputValidSoFar) {
      ...
      System.out.println("Lot number (gardsnummer): ");
      if (reader.hasNextInt()) {
    ...
    // Section number
    if (userInputValidSoFar) {
      System.out.println("Section number (bruksnummer): ");
      if (reader.hasNextInt()) {
    ...
    if (userInputValidSoFar) {
      ...
      System.out.println("Total area of the property, in square meters: ");
  ...
  public void findRealestate() {
    ...
    System.out.println(
        "Search for realestate by municipality number, lot number and section number.");
    System.out.println("");
